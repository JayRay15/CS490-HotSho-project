...
import LinkedJobsModal from "../../components/resume/LinkedJobsModal";
import {
  ModalOverlay,
  ModalCard,
  ModalHeader,
...
export default function ResumeTemplates() {
  ...
  const [showLinkedJobsModal, setShowLinkedJobsModal] = useState(false);
  const [linkedJobsDocument, setLinkedJobsDocument] = useState(null);
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#E4E6E0" }}>
                        ...
                        <div className="px-2 pt-2 pb-2">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex flex-col">
                              ...
                              {letter.linkedJobCount > 0 && (
                                <p className="text-[10px] text-blue-600 font-medium">
                                  Used in {letter.linkedJobCount} application{letter.linkedJobCount !== 1 ? 's' : ''}
                                </p>
                              )}
                            </div>
              ...
              >
                ...
                <div className="bg-gray-50 border-b border-gray-200 px-6 py-4 flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={() => {
                        setLinkedJobsDocument({
                          id: viewingResume._id,
                          type: 'resume',
                          name: viewingResume.name
                        });
                        setShowLinkedJobsModal(true);
                      }}
                      className="px-3 py-1.5 text-sm bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition flex items-center gap-2 border border-blue-200"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Linked Jobs Modal */}
      <LinkedJobsModal
        isOpen={showLinkedJobsModal}
        onClose={() => setShowLinkedJobsModal(false)}
        documentId={linkedJobsDocument?.id}
        documentType={linkedJobsDocument?.type}
        documentName={linkedJobsDocument?.name}
      />
    </div>
  );
}
