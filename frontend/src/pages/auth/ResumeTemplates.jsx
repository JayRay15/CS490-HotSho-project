                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-2">
                              <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                isResume ? 'bg-blue-100' : 'bg-purple-100'
                              }`}>
                                {isResume ? (
                              ...
                              <span className={`text-xs px-2 py-0.5 rounded-full ${
                                isResume ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'
                              }`}>
                            ...
                            {invitation.approvalStatus && (
                              <span className={`text-xs px-2 py-0.5 rounded-full ${
                                invitation.approvalStatus === 'approved' ? 'bg-green-100 text-green-700' :
            ...
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between z-10">
              <div>
                ...
                {shareForCoverLetter.approvalStatus && (
                  <span className={`text-sm px-2 py-1 rounded mt-1 inline-block ${
                    shareForCoverLetter.approvalStatus === 'approved' ? 'bg-green-100 text-green-700' :
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {fb.suggestionType && (
                                <span className={`text-xs px-2 py-0.5 rounded ${
                                  fb.suggestionType === 'critical' ? 'bg-red-100 text-red-700' :
